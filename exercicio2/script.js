...
// const indiceUltimoItemElenco = filme.elenco.length - 1
// console.log(filmes.elenco[ultimoItemElenco])
...
const horarioTransmissao = filme.transmissoesHoje[1].horario
console.log(horarioTransmissao)